          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <button
                ...
                className="px-4 py-2 text-gray-600 hover:text-teal-600 hover:bg-teal-50 rounded-lg transition-colors text-sm font-medium"
              >
                Đăng nhập
              </button>
              <button
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Khám phá những nhà hàng tuyệt vời nhất và lên kế hoạch cho hành
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6">
              ...
              <p className="text-gray-600 text-sm">
                Tìm những nhà hàng địa phương tuyệt nhất và các địa điểm ẩn giấu
                ở Việt Nam
              </p>
            </div>
            <div className="p-6">
        ...
        <div className="mt-16 text-center">
          <button
            onClick={() => router.push("/auth")}
            className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-teal-600 to-cyan-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-shadow"
          >
