...
export default function CreatePostPage() {
    ...
    const handlePublish = async () => {
        ...
        if (accessMode === 'public') {
            ...
            if (wordCount < 200) {
                toast.error(`Public posts require at least 200 words (current: ${wordCount}).`);
                return;
            }
        }
        ...
        try {
            ...
            const articleData = {
                ...
                ...(mode === 'review' && reviewType === 'place' && coords && anchorInput ? {
                    locationContext: {
                ...
                ...(mode === 'review' && reviewType === 'url' && anchorInput ? { url: anchorInput } : {}),
            };
        ...
        return (
            <div className="min-h-screen bg-gray-50 dark:bg-[#0B0E14] flex flex-col items-center justify-center p-6 relative overflow-hidden transition-colors duration-300">
                ...
                <div className="max-w-4xl w-full z-10 animate-fade-in-up">
                    ...
                    <div className={`transition-all duration-500 ease-in-out ${mode ? 'opacity-100 max-h-[900px]' : 'opacity-0 max-h-0 overflow-hidden'}`}>
    ...
    const renderEditor = () => (
        <div className="animate-fade-in relative">
            ...
            {accessMode === 'public' && (() => {
                ...
                return (
                    <div className={`text-xs mt-2 font-mono ${wc >= 200 ? 'text-green-500' : 'text-gray-400'}`}>
                        {wc} / 200 words {wc < 200 ? `(${200 - wc} more needed for public)` : '✓'}
                    </div>
                );
            })()}
        </div>
            ...
            <div className="flex-1 flex flex-col h-full overflow-hidden relative transition-all duration-300">
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar">
                    <div className="max-w-4xl mx-auto mt-0 px-8 pb-32">
                        <div className="flex items-center gap-2 py-3 border-b border-gray-100 dark:border-gray-800 mb-6">
                            <button
                                onClick={() => setViewMode('edit')}
                                className={`px-3 py-1.5 text-xs font-bold rounded-lg transition-colors ${viewMode === 'edit' ? 'bg-gray-900 dark:bg-white text-white dark:text-black' : 'text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800'}`}
                            >Edit</button>
                            <button
