...
import { FIELDS, FEATURED_TAGS, SCHOLARS_OF_WEEK } from '@/data/mockData';

// --- RICH FIELDS ENRICHMENT ---
        ...
        <div className="max-w-6xl mx-auto space-y-12 pb-20">
            ...
            <div>
                <div className="flex items-center justify-between mb-6 px-1">
                    ...
                    <Link href="/app/leaderboard" className="text-xs font-bold text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors flex items-center gap-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                    {SCHOLARS_OF_WEEK.map((scholar) => (
                        <Link
                            key={scholar.id}
                            href={`/app/u/${scholar.name.toLowerCase().replace(' ', '_')}`}
