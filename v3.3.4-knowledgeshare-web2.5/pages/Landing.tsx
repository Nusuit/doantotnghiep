...
const Reveal: React.FC<{ children: ReactNode; className?: string }> = ({ children, className = "" }) => {
...
const LiveTicker: React.FC<{ start: number; suffix?: string }> = ({ start, suffix = "" }) => {
...
const StepIcon3D = ({ icon, color }: { icon: string, color: string }) => {
...
const Landing = () => {
  ...
  // Updated Data with Gold/Silver/Bronze Styles
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg text-gray-900 dark:text-white flex flex-col overflow-x-hidden font-sans">
      
      {/* 1. UPGRADED STICKY HEADER - LARGER */}
      <nav className="fixed top-0 w-full z-50 px-6 py-6 backdrop-blur-xl bg-white/70 dark:bg-dark-bg/80 border-b border-gray-200 dark:border-gray-800 transition-all duration-300">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3">
            {/* CHANGED: KS Logo to Blue Gradient, Larger */}
            <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-cyan-500 rounded-xl flex items-center justify-center text-white font-bold text-2xl shadow-lg shadow-blue-500/20">KS</div>
            <span className="font-bold text-2xl hidden sm:block tracking-tight">KnowledgeShare</span>
          </div>
          
          {/* Centered Navigation - Larger Text */}
          <div className="hidden md:flex items-center gap-8 text-base font-bold text-gray-600 dark:text-gray-300">
              <a href="#explore" className="hover:text-blue-500 transition-colors">Explore</a>
              <a href="#governance" className="hover:text-blue-500 transition-colors">DAO Governance</a>
              <a href="#leaderboard" className="hover:text-blue-500 transition-colors">Leaderboard</a>
              <a href="#economy" className="hover:text-blue-500 transition-colors">Economy</a>
          </div>

          <div className="flex items-center gap-4">
            <Link to="/auth" className="hidden sm:block text-base font-bold hover:text-blue-500 transition-colors">Login</Link>
            {/* UPDATED: Get Started Button to Blue Gradient, Larger */}
            <Link to="/auth" className="px-8 py-3 rounded-full font-bold text-base text-white bg-gradient-to-r from-blue-600 to-cyan-500 hover:shadow-lg hover:shadow-blue-500/30 transition-all transform hover:scale-105">
                Get Started
            </Link>
          </div>
        </div>
      ...
      <div className="relative pt-44 pb-20 px-6 lg:px-8 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[90vh]">
        ...
        <div className="z-10 flex flex-col items-start text-left animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mb-12">
            ...
            <Link to="/auth" className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-8 py-4 text-lg font-bold text-white bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full hover:shadow-xl hover:scale-105 transition-all duration-300 shadow-lg shadow-blue-500/25">
              Start Earning
              <span className="material-symbols-outlined">account_balance_wallet</span>
            </Link>
            <button onClick={() => document.getElementById('pillars')?.scrollIntoView({ behavior: 'smooth'})} className="flex-1 sm:flex-none px-8 py-4 text-lg font-semibold text-gray-700 dark:text-gray-200 bg-white dark:bg-dark-surface border border-gray-200 dark:border-gray-700 rounded-full hover:bg-gray-50 dark:hover:bg-gray-800 transition-all">
              Learn More
            </button>
          </div>
      ...
      <div id="pillars" className="py-28 px-6 relative bg-gradient-to-b from-white to-gray-50 dark:from-[#0F1116] dark:to-[#050608]">
          <div className="max-w-7xl mx-auto">
              <div className="text-center mb-20 relative z-10">
                  <span className="text-primary font-bold tracking-widest uppercase text-sm mb-3 block">Structured Knowledge Graph</span>
      ...
      {/* How It Works Section (The Loop) - NO SCROLL REVEAL & 3D ICONS */}
      <div className="py-24 px-6 bg-gray-50 dark:bg-dark-bg/50 border-t border-gray-200 dark:border-gray-800 relative overflow-hidden">
               ...
               <div 
                 ...
                 style={{
                    ...
                    boxShadow: hoveredStep !== null
                        ? `0 0 15px 2px ${
                            hoveredStep === 0 ? 'rgba(59,130,246,0.5)' :
         ...
         <div id="leaderboard" className="max-w-5xl mx-auto">
            ...
            <div className="space-y-3 relative">
                ...
                {leaderboardPreview.map((user) => (
                    <div 
                        ...
                        className={`relative grid grid-cols-12 items-center px-4 py-3 rounded-xl border transition-all duration-300 ease-out cursor-default ${user.style} ${
                    ...
                    >
                        ...
                        <div className="col-span-5 sm:col-span-6 flex items-center gap-3">
                            <div className={`w-10 h-10 rounded-full flex items-center justify-center text-xs font-bold font-mono tracking-wider transition-transform duration-300 ${
                                user.rank === 1 ? 'bg-yellow-500/10 text-yellow-600 dark:text-yellow-400 border border-yellow-500/30' :
            ...
            <div className="mt-8 text-center">
                <Link to="/auth" className="inline-flex items-center gap-2 text-gray-500 hover:text-blue-500 font-semibold transition-colors">
      ...
      {/* DAO Governance Section - WITH ANIMATED COUNTERS */}
                        ...
                        <div className="group bg-gray-50 dark:bg-dark-bg border border-gray-200 dark:border-gray-700 rounded-3xl p-8 hover:border-purple-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/10">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex justify-between items-center pt-4 border-t border-gray-200 dark:border-gray-700">
                                    ...
                                    <Link to="/auth" className="text-sm font-bold text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 flex items-center gap-1">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div className="col-span-1">
                <div className="flex items-center gap-2 mb-6">
                    <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center text-white font-bold text-sm">KS</div>
            ...
            <div>
                ...
                <ul className="space-y-4 text-sm">
                    <li><a href="#explore" className="hover:text-blue-500 transition-colors">Explore Knowledge</a></li>
                    <li><a href="#economy" className="hover:text-blue-500 transition-colors">Token Economy</a></li>
                    <li><a href="#governance" className="hover:text-blue-500 transition-colors">DAO Governance</a></li>
                    <li><a href="#leaderboard" className="hover:text-blue-500 transition-colors">Leaderboard</a></li>
                </ul>
            </div>
