...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg text-gray-900 dark:text-white flex flex-col overflow-x-hidden font-sans">
      ...
      <nav className="fixed top-0 w-full z-50 px-6 py-4 backdrop-blur-xl bg-white/70 dark:bg-dark-bg/80 border-b border-gray-200 dark:border-gray-800 transition-all duration-300">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <Link to="/auth" className="hidden sm:block text-sm font-semibold hover:text-blue-500 transition-colors">Login</Link>
            {/* UPDATED: Get Started Button to Blue Gradient */}
            <Link to="/auth" className="px-6 py-2.5 rounded-full font-bold text-sm text-white bg-gradient-to-r from-blue-600 to-cyan-500 hover:shadow-lg hover:shadow-blue-500/30 transition-all transform hover:scale-105">
                Get Started
            </Link>
          </div>
        </div>
      ...
      <div className="relative pt-40 pb-20 px-6 lg:px-8 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[90vh]">
