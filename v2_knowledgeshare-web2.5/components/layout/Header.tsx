    ...
    <header className="h-16 border-b border-gray-200 dark:border-gray-800 bg-white/90 dark:bg-[#0B0E14]/90 backdrop-blur-xl flex items-center justify-between px-6 sticky top-0 z-40 transition-all duration-300">
      ...
      <div className="flex items-center gap-3 md:gap-4">
        ...
        >
            ...
            <div className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-900 dark:text-white text-xs font-bold shadow-inner ring-1 ring-gray-200 dark:ring-gray-700">
                {initials}
            </div>
